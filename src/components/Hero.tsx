...
const DoodleArrow = () => (
  <svg width="56" height="28" viewBox="0 0 56 28" fill="none">
    <path d="M2 14 Q 28 9 48 14" stroke="#9ca3af" strokeWidth="2" fill="none" strokeLinecap="round" />
    <path d="M40 7 L 50 14 L 40 21" stroke="#9ca3af" strokeWidth="2" fill="none" strokeLinecap="round" strokeLinejoin="round" />
  </svg>
);
...
const StarDoodle = () => (
  <svg width="22" height="22" viewBox="0 0 22 22" fill="none">
    <path
      ...
      stroke="#fde047" strokeWidth="1.8" fill="#fef9c3"
    />
  </svg>
);
        ...
        <Box className="hero-grid">
          ...
          <Box className="hero-right">
            <Box className="hero-game-board">
              <Typography className="hero-board-label">🎮 game space</Typography>
